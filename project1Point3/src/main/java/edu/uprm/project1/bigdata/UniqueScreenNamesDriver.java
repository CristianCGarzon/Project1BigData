...
public class UniqueScreenNamesDriver {
    ...
    public static void main(String[] args) throws Exception{
        String nameFolder = "Problem3";
        String nameCSVFile = "UniqueScreenName";
        String columns = "uniqueScreenName";
        String programDescription = "Find the set of unique screen names that tweet";
