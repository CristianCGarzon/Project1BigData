...
public class ReplyEachMessageDriver {
    ...
    public static void main(String[] args) throws Exception{
        String nameFolder = "Problem5";
        String nameCSVFile = "Replies";
        String columns = "idReplieed,idReply1,idReply2,idReply3,idReply4,idReply5,idReply6,idReply7,idReply8,idReply9,idReply10,idReply11,idReply12";
        String programDescription = "Find all the replies for each message";
